# Terms and Conditions — Hoopmaster SMS/Email Alert Program
...
Message frequency varies and is triggered by real-world equipment
conditions, not a fixed schedule. You may receive: an initial alert when
a threshold is crossed, periodic re-alerts (approximately every 30
minutes) while the condition persists, and an all-clear message once
resolved. In a fault condition, you may also receive a separate
...
You may opt out of SMS alerts at any time by replying **STOP** to any
...
ejohnston516@msn.com or 913-709-7750.

## Supported Carriers

Carriers are not liable for delayed or undelivered messages. This
service is available on most major US mobile carriers; availability may
vary.
